    ...
    public class TrainingMajorController : AdminBaseController
    {
        ...
        public ActionResult TrainingMajors_Read([DataSourceRequest] DataSourceRequest request)
        {
            DataSourceResult result = _trainingMajorService.GetAll().ToDataSourceResult(request, trainingMajor => new
            {
                ...
                trainingMajor.CreatedAt,
                trainingMajor.CreatedBy,
                trainingMajor.UpdatedAt,
                trainingMajor.UpdatedBy,
                trainingMajor.IsDeleted
            });
            ...
            TrainingMajor trainingMajor)
        {
            ...
            {
                trainingMajor.CreatedBy= User.Identity.GetUserId();
            ...
            TrainingMajor trainingMajor)
        {
            if (ModelState.IsValid)
            {
                trainingMajor.UpdatedBy = User.Identity.GetUserId();
                _trainingMajorService.Update(trainingMajor);
            }
